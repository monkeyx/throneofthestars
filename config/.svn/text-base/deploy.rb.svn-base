## Generated with 'brightbox' on 2012-10-09 09:39:33 +0100
gem 'brightbox', '>=2.3.9'
...
set :application, "throneofthestars"

# Primary domain name of your application. Used in the Apache configs
set :domain, "thronestars.com"

## List of servers
server "thronestars-001.vm.brightbox.net", :app, :web, :db, :primary => true
...
set :repository, "https://monkeyx.svn.beanstalkapp.com/throneofthestars/trunk"
set :scm, :subversion
set :scm_username, 'brightbox'
set :scm_password, 'brightbox'
...
namespace :cache do
	task :clear, :roles => :web do
		run "cd #{current_path} && RAILS_ENV=production bundle exec rake thronestars:clear_cache"
	end
end
