module OrderProcessing
  class AttackShipOrder < CaptainOrder
    ...
    def processable?
      ...
      return false if !@starship.noble_house.at_war?(@target.noble_house) && fail!("Not at war")
      return false if !@target.same_location?(@starship) && fail!("Not at the same location")
      return false if @starship.noble_house_id == @target.noble_house_id && fail!("Cannot attack own ship")
      true
    end
